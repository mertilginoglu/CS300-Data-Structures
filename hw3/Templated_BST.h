...
template <class Comparable>
        ...
        {
           public:
              explicit BinarySearchTree(  Comparable & notFound );
		...
		private:
			...
			BinaryNode<Comparable> * find(  Comparable & x, 
       ...
       /**
		...
		BinarySearchTree( Comparable & notFound ) :
       ...
       /**
        ...
        insert(  Comparable & x, BinaryNode<Comparable> * & t ) 
        {
